...
public class Protocol {
	...
	@DatabaseField(columnName = "errorId")
	...
	@DatabaseField(foreign = true, foreignAutoRefresh = true, columnName = "user_id")//nach string firstName kann man nicht sortieren 
	private User user;
		...
		if(profile !=null){
			...
			try{
				for(String contentString :Autoclave.getInstance().getListContent()){
					sb.append("\n").append("1 x ").append(contentString);
				}
			}catch(Exception e){

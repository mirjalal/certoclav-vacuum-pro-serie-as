...
public class ScanAdapter extends ArrayAdapter<String> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		LinearLayout containerButton = (LinearLayout) convertView.findViewById(R.id.scan_element_container_button);
		containerButton.removeAllViews();
		
		quickActionItemDelete = (QuickActionItem) inflater.inflate(R.layout.quickaction_item, containerButton, false);
		quickActionItemDelete.setChecked(false);
		quickActionItemDelete.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_menu_bin));
			quickActionItemDelete.setText("delete");
			quickActionItemDelete.setOnClickListener(new OnClickListener() {	
				@Override
		...
		containerButton.addView(quickActionItemDelete);

											   ...
											   // PROGRAM parameters  	
											     	...
											     	programJsonArray.put(programJsonObject);
												        	...
												        	switch(protocol.getErrorCode()){
												        		case 1: errorCodeCloud = 14;
												        			break;
												        		case 2: errorCodeCloud = 15;
												        			break;
												        		case 3: errorCodeCloud = 16;
												        			break;
												        		case -1: errorCodeCloud = 15;
												        			break;
												        	}
												        ...
												        int returnval = postUtil.postToCertocloud(body,AppConstants.SERVER_URL + AppConstants.REST_API_POST_PROTOCOLS,true);
